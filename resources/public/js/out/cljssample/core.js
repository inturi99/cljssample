...
secretary.core.add_route_BANG_.call(null,"/",action__4724__auto___4736);

/**
* @param {...*} var_args
*/
cljssample.core.home_path = ((function (action__4724__auto___4736){
return (function() { 
var home_path__delegate = function (args__4723__auto__){
return cljs.core.apply.call(null,secretary.core.render_route_STAR_,"/",args__4723__auto__);
};
var home_path = function (var_args){
var args__4723__auto__ = null;
...
while (G__4737__i < G__4737__a.length) {G__4737__a[G__4737__i] = arguments[G__4737__i + 0]; ++G__4737__i;}
  args__4723__auto__ = new cljs.core.IndexedSeq(G__4737__a,0);
} 
return home_path__delegate.call(this,args__4723__auto__);};
home_path.cljs$lang$maxFixedArity = 0;
home_path.cljs$lang$applyTo = (function (arglist__4738){
var args__4723__auto__ = cljs.core.seq(arglist__4738);
return home_path__delegate(args__4723__auto__);
});
home_path.cljs$core$IFn$_invoke$arity$variadic = home_path__delegate;
return home_path;
})()
;})(action__4724__auto___4736))
;
var action__4724__auto___4741 = (function (params__4725__auto__){
if(cljs.core.map_QMARK_.call(null,params__4725__auto__)){
var map__4739 = params__4725__auto__;
...
secretary.core.add_route_BANG_.call(null,"/:param",action__4724__auto___4741);

/**
* @param {...*} var_args
*/
cljssample.core.some_path = ((function (action__4724__auto___4741){
return (function() { 
var some_path__delegate = function (args__4723__auto__){
return cljs.core.apply.call(null,secretary.core.render_route_STAR_,"/:param",args__4723__auto__);
};
...
while (G__4742__i < G__4742__a.length) {G__4742__a[G__4742__i] = arguments[G__4742__i + 0]; ++G__4742__i;}
  args__4723__auto__ = new cljs.core.IndexedSeq(G__4742__a,0);
} 
return some_path__delegate.call(this,args__4723__auto__);};
some_path.cljs$lang$maxFixedArity = 0;
some_path.cljs$lang$applyTo = (function (arglist__4743){
var args__4723__auto__ = cljs.core.seq(arglist__4743);
return some_path__delegate(args__4723__auto__);
});
some_path.cljs$core$IFn$_invoke$arity$variadic = some_path__delegate;
return some_path;
})()
;})(action__4724__auto___4741))
;
var action__4724__auto___4746 = (function (params__4725__auto__){
if(cljs.core.map_QMARK_.call(null,params__4725__auto__)){
var map__4744 = params__4725__auto__;
...
if(cljs.core.vector_QMARK_.call(null,params__4725__auto__)){
var vec__4745 = params__4725__auto__;
return cljssample.core.set_html_BANG_.call(null,cljssample.core.app,"<h1>Not Found</h1>");
} else {
return null;
}
